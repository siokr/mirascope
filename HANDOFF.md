...
`M03-001` 已完成，下一项为 `M03-002` 漫画领域模型与 schema v4。在线漫画源、站点规则、下载、番剧、账号和同步不属于 0.3。
...
`v0.2.0` 已正式发布；Version 0.3 的依赖、许可证、平台能力和可再分发样例审计已完成，下一步执行 `M03-002` 漫画领域模型与 schema v4。
