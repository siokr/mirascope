...
MVP 0.2 增加 Android 构建、实机主流程和平台存储权限检查。Version 0.3 增加图片解码、缓存和大章节场景；Version 0.4 增加大型混合媒体库查询、备份恢复和阅读体验回归；Version 0.5 增加插件隔离、恶意响应和网络故障；Version 0.6 增加 API、数据库和同步故障测试。
