...
- [x] `M02-003` 安全 ZIP 容器与资源预算（done：20 项路径/预算/读取测试、完整回归 244 项、静态分析通过）
- [x] `M02-004` container、OPF、NCX/nav 与 spine 解析（done：结构解析测试 10 项、完整回归 255 项、CI 同命令格式检查与静态分析通过）
